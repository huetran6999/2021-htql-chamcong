        ...
        <div id="menu1" class="tab-pane" role="tabpanel" aria-labelledby="menu1-tab">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" name="re_name" value="{{$user->parents->re_name}}">
            </div>
            ...
            <div class="col-md-6">
              ...
              <select name="re_gender" class="form-select" id="regenderSelection">
                ...
                <option value="0" @if($user->parents->re_gender == '0') ? selected : null @endif>Nam</option>
                <option value="1" @if($user->parents->re_gender == '1') ? selected : null @endif>Nữ</option>
              </select>
            </div>
            ...
            <div class="col-md-6">
              ...
              <select name="re_ship" class="form-select" id="reshipSelection">
                ...
                <option value="0" @if ($user->parents->re_ship == '0') ? selected : null @endif>Ông</option>
                <option value="1" @if ($user->parents->re_ship == '1') ? selected : null @endif>Bà</option>
                <option value="2" @if ($user->parents->re_ship == '2') ? selected : null @endif>Cha</option>
                <option value="3" @if ($user->parents->re_ship == '3') ? selected : null @endif>Mẹ</option>
                <option value="4" @if ($user->parents->re_ship == '4') ? selected : null @endif>Khác</option>
              </select>
            </div>
            ...
            <div class="col-md-6">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="re_phone" value="{{$user->parents->re_phone}}">
              </div>
            </div>
            ...
            <div class="col-12">
              ...
              <input type="text" class="form-control" name="re_address" value="{{$user->parents->re_address}}" >
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-12">
              ...
              <select name="l_name" class="form-select" id="lnameSelection">
                ...
                <option value="0" @if ($user->literacy->l_name == '0') ? selected : null @endif>Trung học phổ thông</option>
                <option value="1" @if ($user->literacy->l_name == '1') ? selected : null @endif>Trung cấp</option>
                <option value="2" @if ($user->literacy->l_name == '2') ? selected : null @endif>Cao đẳng</option>
                <option value="3" @if ($user->literacy->l_name == '3') ? selected : null @endif>Đại học</option>
                <option value="4" @if ($user->literacy->l_name == '4') ? selected : null @endif>Thạc sĩ</option>
                <option value="5" @if ($user->literacy->l_name == '5') ? selected : null @endif>Tiến sĩ</option>
                <option value="6" @if ($user->literacy->l_name == '6') ? selected : null @endif>PGS.TS</option>
                <option value="7" @if ($user->literacy->l_name == '7') ? selected : null @endif>Khác</option>
              </select>
            </div>

            <div class="col-12">
              <label for="l_major" class="form-label">Ngành học</label>
              <input type="text" class="form-control" name="l_major" value="{{$user->literacy->l_major}}">
            </div>
            ...
            <div class="col-12">
              ...
              <select name="l_name" class="form-select" id="lnameSelection">
                ...
                <option value="0" @if ($user->literacy->l_grading == '0') ? selected : null @endif>Xuất sắc</option>
                <option value="4" @if ($user->literacy->l_grading == '4') ? selected : null @endif>Giỏi</option>
                <option value="1" @if ($user->literacy->l_grading == '1') ? selected : null @endif>Khá</option>
                <option value="2" @if ($user->literacy->l_grading == '2') ? selected : null @endif>Trung bình</option>
                <option value="3" @if ($user->literacy->l_grading == '3') ? selected : null @endif>Khác</option>
              </select>
            </div>

            <div class="col-12">
              <label for="l_graduation_school" class="form-label">Nơi đào tạo</label>
              <input type="text" class="form-control" name="l_graduation_school" value="{{$user->literacy->l_graduation_school}}">
            </div>

            <div class="col-12">
              <label for="l_graduation_year" class="form-label">Năm tốt nghiệp</label>
              <input type="number" class="form-control" name="l_graduation_year" min="1980" max="2022" step="1" value="{{$user->literacy->l_graduation_year}}">
            </div>

            <div class="col-12">
              <label for="l_other_major" class="form-label">Văn bằng khác (nếu có)</label>
              <input type="text" class="form-control" name="l_other_major" value="{{$user->literacy->l_ohter_major}}">
            </div>
