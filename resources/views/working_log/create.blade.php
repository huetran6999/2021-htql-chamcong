...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            ...
            @endif
            <br> 
            <form action="{{ route('store-leave-absence')}}" class="row g-3"  method="post">
                @csrf
                <div class="row mt-5">
                        <div class="col-md-12">
                            <div class="controls">
                                <label>Ngày nghỉ phép</label>
                                <input type="date" class="form-control" placeholder="Chọn ngày" name="date"  autocomplete="off">
                            ...
                            <div class="controls mt-2">
                                ...
                                <span class="text-danger">@error('u_id'){{$message}}@enderror</span>
                            </div>
